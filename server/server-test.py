...
# 建议使用 python3
# 此程序需要安装 twisted 框架，功能为从 TCP 收到 JSON 信息并在服务器中打印出 JSON 信息，同时通过 TCP 返回相同 JSON 信息给客户端。
...
class Chat(LineReceiver):
    ...
    def connectionMade(self):
        print("Log: Connection Made")
        # self.sendLine("What's your name?")

    def connectionLost(self, reason):
        print("Log: Connection Lost")
    ...
    def lineReceived(self, line):
        ...
        for key, value in recJson.items():
            print(key, ':', value)
        ...
        self.sendLine(line.encode(encoding="utf-8"))
